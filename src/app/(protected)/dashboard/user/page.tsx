...
// import { Plus, Search, Ticket, User, Bell, Settings, LogOut, Clock, CheckCircle, AlertCircle, XCircle } from 'lucide-react';
...
//                       <tr key={ticket.id} className="hover:bg-gray-50" onClick={() => setSelectedTicket(ticket)}>
